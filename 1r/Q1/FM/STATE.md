...
- **Notación de fórmulas lógicas**: revertida de LaTeX inline a unicode/texto plano entre backticks (decisión del usuario, 2026-09-21). Convertidas todas las anotaciones LaTeX de `teoria.md` (tema 1, Lògica Proposicional y Lògica de Predicats). `sumatoris.md` y `logica.md` ya estaban en unicode, sin cambios de notación necesarios.

...
## Temario
4 blocs (de CLAUDE.md): Corrent Continu, Corrent Altern, Electrònica i portes lògiques, Ones.

**Pendiente de confirmar:** desglose detallado de subtemas por bloque (más allá de lo ya cubierto en `teoria/teoria.md`, ver STATE.md) y profesor.
...
- Parcial: 03/11/2026 i 23/12/2026 (dos parcials, 13:00-15:00 i 11:00-14:00 respectivament).
- Final: 18/01/2027 11:30-14:30.
- Recuperació: no consta a l'horari oficial (a diferència de PRO1/IC/FM, que sí en tenen el 06/02/2027) — confirmar si F té recuperació.
